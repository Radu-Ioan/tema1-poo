...
public final class Constants {
    ...
    public static final int GENRE_IDX = 1;
    public static final int WORDS_IDX = 2;
    public static final int AWARDS_IDX = 3;
    ...
    public static final String VIEW_MESSAGE = " was viewed with total views of ";
    public static final String FAVORITE_MESSAGE = " was added as favourite";
    public static final String ALREADY_RATED = " has been already rated";
    public static final String RATED_MESSAGE = " was rated with ";
    public static final String UNSEEN_MESSAGE = " is not seen";
    ...
    public static final String STANDARD_RECOMMENDATION = "StandardRecommendation ";
    ...
    public static final String FAILED_RECOMMENDATION = "cannot be applied!";
